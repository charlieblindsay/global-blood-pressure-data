...
st.write('It allows users to interactively explore data from the World Health Organisation and World Bank')
...
st.write('3. Global Variation: A chloropleth shows how the dependent variable varies across the globe in the chosen year')
...
st.write('2 datasets are from The World Health Organisation:')
...
st.write('2 datasets are from The World Bank:')
st.write("- [Population data](https://data.worldbank.org/indicator/SP.POP.TOTL)")
st.write("- [GDP data](https://data.worldbank.org/indicator/NY.GDP.PCAP.PP.KD?end=2021&start=1990&view=chart)")
